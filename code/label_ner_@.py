myType = {
    ...
    # 4: ['小时', '天', '年', '月', '秒'],
    5: ['电缆外护层接地电流', '气体密封性', '直流参考电压', 'UnmA', 'μL/L', '氢气', '总烃', 'kV', '测量准确度', '测量时间', '检测量程', '限流电阻', '直流电阻', '放电频次','测量流量', '取样总流量','气体流量' ],
    6: ['SF6气体湿度', '气体湿度', '气体压力', '含氧量', '风速', '环境温湿度',  '设备压力', '露点值', '管道无渗漏', '管道壁厚度', '管道壁厚', '电晕放电'],
